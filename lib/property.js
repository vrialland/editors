...
Property.prototype.INITIAL_ERROR_STATE = 'Initial error state';


Property.prototype._initialError = function (value) {
 ...
 */
 Property.prototype.set = function (input, validator) {
 ...
 */
Property.prototype.error = function () {
    return this._error;
};
 ...
 */
Property.prototype.hasValidValue = function () {
